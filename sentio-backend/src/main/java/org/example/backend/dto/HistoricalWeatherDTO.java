 ...
 * Contains comprehensive past weather conditions, temporal data, and location details
...
public class HistoricalWeatherDTO {
    ...
    // Weather conditions
    @Schema(description = "Weather code following WMO standards", example = "3",
    ...
    @Schema(description = "Main weather category", example = "Rain",
