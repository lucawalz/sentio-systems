        ...
        public OpenAPI openAPI() {
                ...
                Info info = new Info()
                                ...
                                .description("""
                                                ...
                                                ## Features
                                                - **Weather Data**: Real-time sensor data from IoT devices
                                                - **Weather Forecasts**: 7-day forecasts from Open-Meteo API
                                                - **Historical Weather**: Historical weather data archive
                                                - **Weather Alerts**: Real-time warnings from BrightSky API
