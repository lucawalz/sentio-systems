...
public interface WeatherForecastRepository extends JpaRepository<WeatherForecast, Long> {
    ...
    List<WeatherForecast> findByDateRange(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
    ...
    // Delete forecasts that are too old based on forecast date (cleanup stale future forecasts)
    @Modifying
    @Transactional
    ...
    List<WeatherForecast> findLatestForecastsInRange(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
