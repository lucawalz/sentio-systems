...
public interface HistoricalWeatherRepository extends JpaRepository<HistoricalWeather, Long> {
    ...
    List<HistoricalWeather> findByDateRange(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
    ...
    // Find missing historical dates for a location within a range
