...
/**
 * Service responsible for managing animal detection data and analytics operations.
 * Handles persistence, retrieval, and statistical analysis of AI-powered animal detection results.
 * <p>
 * This service provides comprehensive functionality for storing detection data from
 * computer vision models, generating analytics summaries, and managing associated
...
public class AnimalDetectionService {
    ...
    public AnimalDetection saveAnimalDetection(AnimalDetection animalDetection) {
        log.info("Saving animal detection - Type: {}, Species: {} with confidence: {:.2f}",
                animalDetection.getAnimalType(), animalDetection.getSpecies(), animalDetection.getConfidence());
    ...
    public List<AnimalDetection> getLatestDetections(int limit) {
        ...
        return animalDetectionRepository.findTopNByOrderByTimestampDesc(limit);
    }
    ...
    public List<AnimalDetection> getRecentDetections(int hours) {
        ...
        return animalDetectionRepository.findRecentDetections(startTime);
    }
    ...
    public List<AnimalDetection> getDetectionsByDate(LocalDate date) {
        ...
        return animalDetectionRepository.findByTimestampBetweenOrderByTimestampDesc(startOfDay, endOfDay);
    }
    ...
    public List<AnimalDetection> getDetectionsBySpecies(String species, Pageable pageable) {
        ...
        return animalDetectionRepository.findBySpeciesIgnoreCaseOrderByTimestampDesc(species, pageable);
    }

    /**
     * Retrieves animal detections for a specific animal type with pagination support.
     *
    ...
    public List<AnimalDetection> getDetectionsByAnimalType(String animalType, Pageable pageable) {
        ...
        return animalDetectionRepository.findByAnimalTypeIgnoreCaseOrderByTimestampDesc(animalType, pageable);
    }
    ...
    /**
     * Generates comprehensive detection summary with statistics for a given timeframe.
     *
    ...
    public AnimalDetectionSummary getDetectionSummary(int hours) {
        ...
        if (!recentDetections.isEmpty()) {
            ...
            mostActiveEntry.ifPresent(integerLongEntry -> summary.setMostActiveHour(String.format("%02d:00", integerLongEntry.getKey())));
            ...
            log.info("Generated summary for {} detections: {} unique species, {} animal types, avg confidence: {:.2f}",
                    recentDetections.size(), uniqueSpecies.size(), uniqueAnimalTypes.size(), avgConfidence);
        }
    ...
    public Map<Integer, Long> getHourlyActivity(LocalDate date) {
        ...
        LocalDateTime startOfDay = date.atStartOfDay();
        LocalDateTime endOfDay = date.atTime(23, 59, 59);
        List<AnimalDetection> dayDetections = animalDetectionRepository.findByTimestampBetweenOrderByTimestampDesc(startOfDay, endOfDay);
    ...
    public Map<String, Object> getSystemStats() {
        ...
        log.info("Generated system stats - Total: {}, Today: {}, Week: {}, Species: {}, Animal Types: {}",
                totalDetections, todayDetections.size(), weekDetections.size(), uniqueSpeciesCount, allAnimalTypeCount.size());
