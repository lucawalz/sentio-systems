 ...
 * Provides endpoints for retrieving detection data, species analytics, and device statistics
...
public class AnimalDetectionController {
     ...
     */
    @Operation(summary = "Get recent animal detections",
            description = "Retrieves animal detections from the specified number of hours in the past", tags = {"Read"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved recent detections",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = AnimalDetectionDTO.class))))
    })
    @GetMapping("/recent")
    public ResponseEntity<List<AnimalDetectionDTO>> getRecentDetections(
        ...
        List<AnimalDetection> detections = animalDetectionService.getRecentDetections(hours);
        List<AnimalDetectionDTO> dtos = mapper.toDTOList(detections);
     ...
     */
    @Operation(summary = "Get detections by date",
            description = "Retrieves all animal detections for a specific date", tags = {"Read"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved detections for date",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = AnimalDetectionDTO.class))))
    })
    @GetMapping("/by-date")
    public ResponseEntity<List<AnimalDetectionDTO>> getDetectionsByDate(
            @Parameter(description = "Target date for detections (ISO format: yyyy-MM-dd)")
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
        logger.info("Retrieving animal detections for date: {}", date);
        List<AnimalDetection> detections = animalDetectionService.getDetectionsByDate(date);
        List<AnimalDetectionDTO> dtos = mapper.toDTOList(detections);
     ...
     */
    @Operation(summary = "Get detections by species",
            description = "Retrieves animal detections for a specific species with pagination", tags = {"Read"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved detections for species",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = AnimalDetectionDTO.class))))
    })
    @GetMapping("/by-species")
    public ResponseEntity<List<AnimalDetectionDTO>> getDetectionsBySpecies(
            @Parameter(description = "Animal species name to filter by")
        ...
        List<AnimalDetection> detections = animalDetectionService.getDetectionsBySpecies(species, pageable);
        List<AnimalDetectionDTO> dtos = mapper.toDTOList(detections);
     ...
     */
    @Operation(summary = "Get detections by animal type",
            description = "Retrieves animal detections for a specific animal type (e.g., 'bird', 'mammal') with pagination", tags = {"Read"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved detections for animal type",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = AnimalDetectionDTO.class))))
    })
    @GetMapping("/by-type")
    public ResponseEntity<List<AnimalDetectionDTO>> getDetectionsByAnimalType(
            @Parameter(description = "Animal type to filter by (e.g., 'bird', 'mammal')")
        ...
        Pageable pageable = PageRequest.of(page, size);
        List<AnimalDetection> detections = animalDetectionService.getDetectionsByAnimalType(animalType, pageable);
        List<AnimalDetectionDTO> dtos = mapper.toDTOList(detections);
     ...
     */
    @Operation(summary = "Get detections by device",
            description = "Retrieves animal detections for a specific device with pagination")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved detections for device",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = AnimalDetectionDTO.class))))
    })
    @GetMapping("/by-device")
    public ResponseEntity<List<AnimalDetectionDTO>> getDetectionsByDevice(
            @Parameter(description = "Device identifier to filter by")
        ...
        Pageable pageable = PageRequest.of(page, size);
        List<AnimalDetection> detections = animalDetectionService.getDetectionsByDevice(deviceId, pageable);
        List<AnimalDetectionDTO> dtos = mapper.toDTOList(detections);
     ...
     */
    @Operation(summary = "Get detection summary",
            description = "Retrieves comprehensive detection analytics and summary statistics for a time period")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved detection summary",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = AnimalDetectionSummary.class)))
    })
    @GetMapping("/summary")
    public ResponseEntity<AnimalDetectionSummary> getDetectionSummary(
            @Parameter(description = "Time period in hours for analysis")
            @RequestParam(defaultValue = "24") int hours) {
     ...
     */
    @Operation(summary = "Get species count",
            description = "Retrieves detection counts grouped by species for analytics")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved species counts",
                    content = @Content(mediaType = "application/json"))
    })
    ...
    public ResponseEntity<Map<String, Long>> getSpeciesCount(
        ...
        Map<String, Long> speciesCount = animalDetectionService.getSpeciesCount(hours);
     ...
     */
    @Operation(summary = "Get animal type count",
            description = "Retrieves detection counts grouped by animal type for analytics")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved animal type counts",
                    content = @Content(mediaType = "application/json"))
    })
    ...
    public ResponseEntity<Map<String, Long>> getAnimalTypeCount(
        ...
        Map<String, Long> typeCount = animalDetectionService.getAnimalTypeCount(hours);
     ...
     */
    @Operation(summary = "Get hourly activity",
            description = "Retrieves hourly detection activity patterns for a specific date")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved hourly activity data",
                    content = @Content(mediaType = "application/json"))
    })
    @GetMapping("/hourly-activity")
    public ResponseEntity<Map<Integer, Long>> getHourlyActivity(
            @Parameter(description = "Target date for activity analysis (ISO format: yyyy-MM-dd)")
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
        logger.info("Retrieving hourly activity for date: {}", date);
        Map<Integer, Long> hourlyActivity = animalDetectionService.getHourlyActivity(date);
     ...
     */
    @Operation(summary = "Get high-confidence detections",
            description = "Retrieves animal detections with confidence scores above a specified threshold")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved high-confidence detections",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = AnimalDetectionDTO.class))))
    })
    @GetMapping("/high-confidence")
    public ResponseEntity<List<AnimalDetectionDTO>> getHighConfidenceDetections(
            @Parameter(description = "Minimum confidence score (0.0-1.0)")
            @RequestParam(defaultValue = "0.8") float minConfidence,
            @Parameter(description = "Time period in hours")
            @RequestParam(defaultValue = "24") int hours) {
        logger.info("Retrieving high-confidence detections (min: {}) from last {} hours", minConfidence, hours);
        List<AnimalDetection> detections = animalDetectionService.getHighConfidenceDetections(minConfidence, hours);
        List<AnimalDetectionDTO> dtos = mapper.toDTOList(detections);
     ...
     */
    @Operation(summary = "Get detection by ID",
            description = "Retrieves a specific animal detection by its ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved the detection",
                    content = @Content(mediaType = "application/json",
    ...
    public ResponseEntity<AnimalDetectionDTO> getDetectionById(
            @Parameter(description = "Detection ID")
            @PathVariable Long id) {
        logger.info("Retrieving detection with ID: {}", id);
        return animalDetectionService.getDetectionById(id)
                .map(detection -> {
    ...
    public ResponseEntity<AnimalDetectionDTO> recordDetection(
            ...
            @RequestBody AnimalDetectionDTO detectionDTO) {
        ...
        AnimalDetection savedDetection = animalDetectionService.saveAnimalDetection(detection);
     ...
     */
    @Operation(summary = "Delete detection",
            description = "Deletes a specific animal detection by its ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Successfully deleted the detection",
                    content = @Content),
            @ApiResponse(responseCode = "404", description = "Detection not found",
                    content = @Content)
    })
    ...
    public ResponseEntity<Void> deleteDetection(
            @Parameter(description = "Detection ID to delete")
            @PathVariable Long id) {
        logger.info("Deleting detection with ID: {}", id);
        if (animalDetectionService.deleteDetection(id)) {
    ...
    @Operation(summary = "Get system statistics",
            description = "Retrieves comprehensive system statistics and metrics about animal detections")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Map<String, Object>> getSystemStats() {
        ...
        Map<String, Object> stats = animalDetectionService.getSystemStats();
    ...
    @Operation(summary = "Get all species",
            description = "Retrieves all distinct species names in the system")
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<String>> getAllSpecies() {
        ...
        List<String> species = animalDetectionService.getAllSpecies();
     ...
     */
    @Operation(summary = "Get all animal types",
            description = "Retrieves all distinct animal types in the system")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved animal types list",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = String.class))))
    })
    @GetMapping("/types")
    public ResponseEntity<List<String>> getAllAnimalTypes() {
        ...
        List<String> animalTypes = animalDetectionService.getAllAnimalTypes();
     ...
     */
    @Operation(summary = "Get mammal detections",
            description = "Retrieves detections specifically for mammals")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved mammal detections",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = AnimalDetectionDTO.class))))
    })
    @GetMapping("/mammals")
    public ResponseEntity<List<AnimalDetectionDTO>> getMammalDetections(
        ...
        List<AnimalDetection> detections = animalDetectionService.getMammalDetections(hours);
        List<AnimalDetectionDTO> dtos = mapper.toDTOList(detections);
