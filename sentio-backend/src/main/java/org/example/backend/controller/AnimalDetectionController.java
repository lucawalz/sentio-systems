...
@CrossOrigin(origins = "*")
@Tag(name = "Animal Detection", description = """
...
public class AnimalDetectionController {
         ...
         */
        @Operation(summary = "Get latest animal detections", description = """
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved latest detections", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = AnimalDetectionDTO.class)), examples = @ExampleObject(name = "Bird Detections Example", summary = "Two recent bird detections", value = """
                                        [
                                          {
                                            "id": 123,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "Invalid limit parameter (must be 1-100)", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = """
                                        {
                                          "error": "Bad Request",
         ...
         */
        @Operation(summary = "Record new detection", description = """
                        Records a new animal detection event in the system.
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Detection recorded successfully, AI classification pending", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AnimalDetectionDTO.class), examples = @ExampleObject(value = """
                                        {
                                          "id": 124,
                                          "species": "Unknown",
                                          "animalType": "bird",
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "Invalid detection data", content = @Content(examples = @ExampleObject(value = """
                                        {
