...
public class RaspiWeatherController {
         ...
         */
        @Operation(summary = "Get latest weather data", description = "Retrieves the most recent weather data reading from IoT sensors")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved latest weather data", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RaspiWeatherData.class))),
                        @ApiResponse(responseCode = "404", description = "No weather data found", content = @Content)
        })
        @GetMapping("/latest")
         ...
         */
        @Operation(summary = "Get recent weather data", description = "Retrieves recent weather data entries from IoT sensors")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved recent weather data", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = RaspiWeatherData.class))))
        })
        @GetMapping("/recent")
         ...
         */
        @Operation(summary = "Get all weather data", description = "Retrieves all available weather data entries from the database")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved all weather data", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = RaspiWeatherData.class))))
        })
        @GetMapping("/all")
         ...
         */
        @Operation(summary = "Add new weather data", description = "Adds new weather data reading to the system from IoT devices")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully added weather data", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RaspiWeatherData.class))),
                        @ApiResponse(responseCode = "400", description = "Invalid weather data provided", content = @Content)
        })
        @PostMapping
         ...
         */
        @Operation(summary = "Get weather statistics", description = "Retrieves comprehensive weather statistics and analytics including averages and totals")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved weather statistics", content = @Content(mediaType = "application/json", schema = @Schema(implementation = WeatherStats.class)))
        })
        @GetMapping("/stats")
        ...
        public static class WeatherStats {
                ...
                public RaspiWeatherData getLatest() {
                        return latest;
                }

                public void setLatest(RaspiWeatherData latest) {
                        this.latest = latest;
                }
