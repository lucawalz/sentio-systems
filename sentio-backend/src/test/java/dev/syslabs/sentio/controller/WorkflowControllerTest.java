...
import dev.syslabs.sentio.service.WorkflowService;
...
class WorkflowControllerTest {
    ...
    void getMyWeatherSummary_returns200_whenPresent() throws Exception {
        try (org.mockito.MockedStatic<dev.syslabs.sentio.util.SecurityUtils> mocked = mockStatic(
                dev.syslabs.sentio.util.SecurityUtils.class)) {
            mocked.when(dev.syslabs.sentio.util.SecurityUtils::getCurrentUserId).thenReturn("user-1");
            WorkflowResult summary = new WorkflowResult();
    ...
    void getMySightingsSummary_returns200_whenPresent() throws Exception {
        try (org.mockito.MockedStatic<dev.syslabs.sentio.util.SecurityUtils> mocked = mockStatic(
                dev.syslabs.sentio.util.SecurityUtils.class)) {
            mocked.when(dev.syslabs.sentio.util.SecurityUtils::getCurrentUserId).thenReturn("user-2");
            WorkflowResult summary = new WorkflowResult();
    ...
    void getMyRecentResults_returns200() throws Exception {
        try (org.mockito.MockedStatic<dev.syslabs.sentio.util.SecurityUtils> mocked = mockStatic(
                dev.syslabs.sentio.util.SecurityUtils.class)) {
            mocked.when(dev.syslabs.sentio.util.SecurityUtils::getCurrentUserId).thenReturn("user-3");
    ...
    void createUserWorkflowResult_returns200() throws Exception {
        try (org.mockito.MockedStatic<dev.syslabs.sentio.util.SecurityUtils> mocked = mockStatic(
                dev.syslabs.sentio.util.SecurityUtils.class)) {
            mocked.when(dev.syslabs.sentio.util.SecurityUtils::getCurrentUserId).thenReturn("user-4");
    ...
    void generateWeatherSummary_returns202_whenTrue() throws Exception {
        try (org.mockito.MockedStatic<dev.syslabs.sentio.util.SecurityUtils> mocked = mockStatic(
                dev.syslabs.sentio.util.SecurityUtils.class)) {
            mocked.when(dev.syslabs.sentio.util.SecurityUtils::getCurrentUserId).thenReturn("user-5");
    ...
    void generateSightingsSummary_returns202_whenTrue() throws Exception {
        try (org.mockito.MockedStatic<dev.syslabs.sentio.util.SecurityUtils> mocked = mockStatic(
                dev.syslabs.sentio.util.SecurityUtils.class)) {
            mocked.when(dev.syslabs.sentio.util.SecurityUtils::getCurrentUserId).thenReturn("user-6");
    ...
    void askAgent_returns200_whenResponseNotNull() throws Exception {
        try (org.mockito.MockedStatic<dev.syslabs.sentio.util.SecurityUtils> mocked = mockStatic(
                dev.syslabs.sentio.util.SecurityUtils.class)) {
            mocked.when(dev.syslabs.sentio.util.SecurityUtils::getCurrentUserId).thenReturn("user-7");
