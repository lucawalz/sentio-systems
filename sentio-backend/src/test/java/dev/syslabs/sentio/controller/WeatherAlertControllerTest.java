...
import dev.syslabs.sentio.mapper.WeatherAlertMapper;
import dev.syslabs.sentio.model.WeatherAlert;
import dev.syslabs.sentio.service.IBrightSkyService;
...
class WeatherAlertControllerTest {
    ...
    static class TestBeans {
        ...
        void fetchRadarMetadata_returns200_whenNotNull() throws Exception {
                dev.syslabs.sentio.dto.RadarMetadataDTO metadata = dev.syslabs.sentio.dto.RadarMetadataDTO.builder()
        ...
        void getLatestRadarMetadata_returns200_whenPresent() throws Exception {
                dev.syslabs.sentio.model.WeatherRadarMetadata metadata = new dev.syslabs.sentio.model.WeatherRadarMetadata();
