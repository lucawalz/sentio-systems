 ...
 * - Test various workflow types (weather summary, sightings summary, AI agent, animal detection)
...
class N8nWorkflowTriggerServiceIT extends BaseIntegrationTest {
    ...
    class AnimalDetectionTests {
        ...
        void triggerAnimalDetectionWorkflow_withValidData_shouldReturnTrue() {
            ...
            // Act
            boolean result = n8nWorkflowTriggerService.triggerAnimalDetectionWorkflow(deviceId, species, confidence);
