        ...
        <section id="pricing" className="py-16 md:py-32">
            <div className="mx-auto max-w-6xl px-6">
                <div className="mx-auto max-w-2xl space-y-6 text-center">
                    ...
                    <p>From individual researchers to enterprise deployments, Sentio offers flexible plans to match your environmental monitoring needs.</p>
                </div>
                ...
                <div className="mt-8 grid gap-6 md:mt-20 md:grid-cols-3">
                    <Card className="flex flex-col">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <ul className="list-outside space-y-3 text-sm">
                                {['Personal Environment Dashboard', 'Local Weather Alerts', 'Community Data Access'].map((item, index) => (
                                    <li
                                        key={index}
                    ...
                    <Card className="relative">
                        ...
                        <div className="flex flex-col">
                            <CardHeader>
                                ...
                                <CardDescription className="text-sm">Per sensor hub</CardDescription>
                            </CardHeader>

                            <CardContent className="space-y-4">
                                <hr className="border-dashed" />
                                <ul className="list-outside space-y-3 text-sm">
                                    {['Everything in Explorer', 'Advanced Climate Analytics', 'Species Recognition AI', 'Historical Data Export', 'Custom Alert Thresholds', 'API Access', 'Mobile App Premium', 'Priority Support', 'Monthly Research Reports', 'Enhanced Security'].map((item, index) => (
                                        <li
                                            key={index}
                                            className="flex items-center gap-2">
                                            <Check className="size-3" />
                    ...
                    <Card className="flex flex-col">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <ul className="list-outside space-y-3 text-sm">
                                {['Everything in Professional', 'Unlimited Sensor Nodes', 'Dedicated Account Manager'].map((item, index) => (
                                    <li
                                        key={index}
                                        className="flex items-center gap-2">
                                        <Check className="size-3" />
