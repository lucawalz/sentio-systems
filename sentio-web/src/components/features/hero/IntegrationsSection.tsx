            ...
            <div className="bg-background py-24 md:py-32">
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="mx-auto mt-12 max-w-lg space-y-6 text-center">
                        <h2 className="text-balance text-3xl font-semibold md:text-4xl">Powered by leading AI models</h2>
                        <p className="text-muted-foreground">Sentio integrates with state-of-the-art AI to deliver accurate species recognition and climate analysis.</p>
                    </div>
                </div>
            </div>
        </section>
