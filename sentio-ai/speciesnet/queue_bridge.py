"""
Queue Bridge for SpeciesNet AI Service
...
# Queue names
JAVA_QUEUE = "speciesnet:queue:java"
...
async def run_bridge():
    ...
    logger.info("=" * 50)
    logger.info("QUEUE BRIDGE STARTING - Loading SpeciesNet model...")
    logger.info("=" * 50)
    ...
    logger.info("SpeciesNet model loaded - Bridge ready")
